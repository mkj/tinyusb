 ...
 *
 * Generated: 2021-06-28 13:53:40.143773.
 */
...
#define USB_DEVICE_CONTROLLER_SPEED_ADDRESS (0x00050004U)
#define USB_DEVICE_CONTROLLER_SPEED_SIZE (4)
static inline uint32_t usb_device_controller_speed_read(void) {
    volatile uint32_t *reg = (uint32_t *)USB_DEVICE_CONTROLLER_SPEED_ADDRESS;
    return *reg;
}
...
#define USB_OUT_EP_DATA_EP_ADDRESS (0x00080004U)
#define USB_OUT_EP_DATA_EP_SIZE (4)
static inline uint32_t usb_out_ep_data_ep_read(void) {
    volatile uint32_t *reg = (uint32_t *)USB_OUT_EP_DATA_EP_ADDRESS;
    return *reg;
}

#define USB_OUT_EP_RESET_ADDRESS (0x00080008U)
...
#define USB_OUT_EP_EPNO_ADDRESS (0x0008000cU)
...
#define USB_OUT_EP_ENABLE_ADDRESS (0x00080010U)
...
#define USB_OUT_EP_PRIME_ADDRESS (0x00080014U)
#define USB_OUT_EP_PRIME_SIZE (4)
static inline void usb_out_ep_prime_write(uint32_t value) {
    volatile uint32_t *reg = (uint32_t *)USB_OUT_EP_PRIME_ADDRESS;
    *reg = value;
}

#define USB_OUT_EP_STALL_ADDRESS (0x00080018U)
...
#define USB_OUT_EP_HAVE_ADDRESS (0x0008001cU)
...
#define USB_OUT_EP_PEND_ADDRESS (0x00080020U)
...
#define USB_OUT_EP_ADDRESS_ADDRESS (0x00080024U)
...
#define USB_OUT_EP_PID_ADDRESS (0x00080028U)
